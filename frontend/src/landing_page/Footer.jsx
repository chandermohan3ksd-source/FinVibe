        ...
        <div className="container">
            <div className="row pt-5">
                ...
                <div className="col">
                    ...
                    <a href=""className="text-muted">Product</a><br/>
                ...
                <div className="col ">
                    ...
                    <a href=""  className="text-muted">Contact</a><br/>
                    <a href=""  className="text-muted">Support portal</a><br/>
                    <a href=""  className="text-muted">Z-Connect bing</a><br/>
                ...
                <div className="col">
                    ...
                    <a href=""  className="text-muted">60 day chalenge</a><br/>
...
<p><b>NSE </b> &nbsp;  &nbsp; <b>BSE</b>  &nbsp; &nbsp; <b>MCX</b>  &nbsp; &nbsp;<b>Terms & conditions</b> &nbsp; &nbsp; <b>Policies & procedures</b>  &nbsp; &nbsp;<b>Privacy policy </b> &nbsp; &nbsp;<b>Disclosure For investor's attention</b> &nbsp; &nbsp; <b>Investor charter</b></p>
