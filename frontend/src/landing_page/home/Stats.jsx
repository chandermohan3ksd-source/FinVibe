    ...
    return(
        ...
        <div className="container p-5">
            <div className="row">
                ...
                <div className="col-6 p-5">
                    <img src="Media/Images/ecosystem.png" alt="Ecosystem Imgaes" style={{width:"90%"}} />
                    <div className="text-center">
                        <a href="" style={{textDecoration:"none"}} className="mx-5">Explore our products <i className="fa-solid fa-arrow-right-long"></i></a>
